...
- In the _slides_ folder create a project-specific-folder (i.e., wpa)
...
- change yaml: menu: example*tech: (previously \_just* example)

- add \_index.md, _outside_ example_tech folder (path: content/technical_notes/)
- change yaml title: technical_notes

- add \_index.md, _inside_ example_tech folder (path: content/technical_notes/example/)
